...
// You do not need to code here, this is an example method
    ...
    public String guestGreeting(String name, String dayPeriod) {
        String namedGreeting = String.format("Good %s, %s. It's a lovely %s.", dayPeriod, name, dayPeriod);
    ...
    public String dateAnnouncement() {
        String dateAnnounced = String.format("Today is %s", java.time.LocalDate.now());
